...
public enum Fruit {
    ...
    NETHER_WART(5, 56, 0.125F, Blocks.NETHER_WART_BLOCK),
    SHROOMLIGHT(6, 78, 0.075F, Blocks.SHROOMLIGHT),
    PUMPKIN(7, 92, 0.025F, Blocks.PUMPKIN),
    WATERMELON(8, 240, 0.012F, Blocks.MELON);
    private int size;
    private int score;
