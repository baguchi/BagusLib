...
public class BookScreen extends Screen {
    ...
    @Override
    protected void init() {
        leftButton = addRenderableWidget(new BaguPageButton(getBaseX(), getBaseY() + book.height(), book, false, true, button -> flipLeft()));
        rightButton = addRenderableWidget(new BaguPageButton(getBaseX() + book.width() - book.buttonWidth(), getBaseY() + book.height(), book, true, true, button -> flipRight()));
        pageSize = 0;
