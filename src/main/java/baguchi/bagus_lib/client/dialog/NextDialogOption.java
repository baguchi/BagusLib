...
public record NextDialogOption(Optional<Identifier> nextDialogLocation, long dialogRenderTime) {
    public static final MapCodec<NextDialogOption> CODEC = RecordCodecBuilder.mapCodec(
            p_345644_ -> p_345644_.group(Identifier.CODEC.optionalFieldOf("next_dialog").forGetter(NextDialogOption::nextDialogLocation),
