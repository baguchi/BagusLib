...
public class ModSensors {
    ...
    public static final RegistryObject<SensorType<SmartNearestLivingEntitySensor<?>>> SMART_NEAREST_LIVING_ENTITY_SENSOR = SENSOR_TYPES.register("smart_nearest_living_entity_sensor",
