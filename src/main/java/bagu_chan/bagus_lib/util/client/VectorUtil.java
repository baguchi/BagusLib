...
public class VectorUtil {
    ...
    public static void moveVecToPart(Vector3f vector3f, Optional<ModelPart> optionalModelPart) {
        optionalModelPart.ifPresent(part -> {
            part.xRot = vector3f.x;
            part.yRot = vector3f.y;
            part.zRot = vector3f.z;
        });
    ...
    public static void moveVecToPartWithAdd(Vector3f vector3f, Optional<ModelPart> optionalModelPart) {
        optionalModelPart.ifPresent(part -> {
            part.xRot += vector3f.x;
            part.yRot += vector3f.y;
            part.zRot += vector3f.z;
