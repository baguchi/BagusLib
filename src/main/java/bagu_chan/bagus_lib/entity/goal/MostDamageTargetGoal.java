...
/**
 * Based code From Aether
 * <a href="https://github.com/The-Aether-Team/The-Aether/blob/1.21.1-develop/src/main/java/com/aetherteam/aether/entity/ai/goal/MostDamageTargetGoal.java">...</a>
...
public class MostDamageTargetGoal extends TargetGoal {
    ...
    public void addAggro(LivingEntity attacker, double damage) {
        ...
        this.hurtByAttacker(attacker, this.attackers.getOrDefault(attacker, 0.0));
    }
